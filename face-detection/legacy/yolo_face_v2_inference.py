...
from yolo_face_v2 import YOLOFace, IMAGE_WIDTH, IMAGE_HEIGHT


logging.basicConfig()
logger = logging.getLogger('yolo face v1 inference')
...
def main():
  ...
  parser.add_argument('--checkpoint', dest='checkpoint',
    default='yolo_face_v2_0/yolo_face-100000', help='checkpoint to load')
