...
from yolo_face_v2 import YOLOFace
from yolo_face_v2_batcher import ImageBatch
...
def train():
  ...
  parser.add_argument('--lambda-coord', dest='lambda_coord',
    default=3.0, type=float, help='coordinate loss adjustment')
  parser.add_argument('--lambda-noobj', dest='lambda_noobj',
    default=0.3, type=float, help='no object loss adjustment')

  parser.add_argument('--learning-rate', dest='learning_rate',
    default=1e-3, type=float, help='learning rate to train')
  parser.add_argument('--batch-size', dest='batch_size',
    default=32, type=int, help='batch size to train model')
  parser.add_argument('--max-epoch', dest='max_epoch',
    default=100000, type=int, help='max epoch train model')
  ...
  if args.save:
    ...
    num_model = 0
    checkpoint_path = 'yolo_face_v2_%d' % (num_model)
