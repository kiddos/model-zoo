...
from yolo_face_v9 import YOLOFace
from yolo_face_v9_batcher import ImageBatch
...
def train():
  ...
  parser.add_argument('--learning-rate', dest='learning_rate',
    default=1e-4, type=float, help='learning rate to train')
  ...
  if args.save:
    ...
    num_model = 0
    checkpoint_path = 'yolo_face_v9_%d' % (num_model)
